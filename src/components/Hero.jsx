...
export default function Hero() {
  return (
    <section className="relative pb-10 overflow-hidden h-[600px] lg:h-auto lg:mt-0">
      <div className="flex flex-col lg:flex-row justify-center items-center overflow-hidden">
        {/* Sol kısım (başlık ve açıklama) */}
        <div className="w-2/3 lg:w-1/3 text-[#575759] flex flex-col items-center lg:items-start px-28 lg:px-0 ">
          <h1 className="text-2xl lg:text-4xl font-extrabold">BİZ KİMİZ ?</h1>
          <p className="text-xl p-1 lg:w-full mx-auto lg:mx-0 text-center lg:text-left">
            SPELYA Yazılım Olarak 2023 Yılından İtibaren Hizmetler vermekteyiz.
            Müşterilerimizde en uygun Hizmetlerden Yararlanabilirsiniz.
          </p>
          <Link href="/lisance">
            <Button className="w-max uppercase mx-auto lg:mx-0">lisansları incele</Button>
          </Link>
        </div>

        {/* Sağ kısım (infinite scroll) */}
        <div className="w-full lg:w-1/2 flex overflow-hidden justify-center lg:justify-start mt-10 lg:mt-0">
