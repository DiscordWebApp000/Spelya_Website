...
export default function Trail() {
  return (
    <section style={{ backgroundImage: "url('/img/site_arka_plan_deneme_.webp')" }} className=" bg-no-repeat bg-cover border-2 px-4 text-center h-[40vh] gap-4 border-primary rounded-xl w-full flex justify-center items-center flex-col w-[96%] mx-auto">
